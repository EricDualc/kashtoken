...
contract KASHToken is StandardToken {
     ...
     */
    function KASHToken(address _target) {
        target = _target;
    }
    ...
    /// @dev Compute the amount of KASH token that can be purchased.
    /// @param ethAmount Amount of Ether to purchase KASH.
    /// @return Amount of KASH token to purchase
